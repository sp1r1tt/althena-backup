...
export default function SelfImprovementPrompt() {
  return (
    <div className="w-full flex flex-col sm:flex-row gap-[8px] mt-[8px]">
      ...
      <div className="w-full sm:w-[300px] h-[300px] bg-[rgba(237,191,171,1)] rounded-lg flex flex-col items-center justify-center text-center p-4">
        <h3 className="text-[21px] xs:text-[23px] sm:text-[25px] md:text-[27px] lg:text-[29px] font-playfair leading-none mb-4">
        </h3>
        <Link
          href="/self-knowledge-space"
          className="inline-block px-6 py-3 bg-[#8EB5BA] text-white no-underline rounded-[30px] text-base font-playfair transition-colors duration-300 hover:bg-white hover:text-[rgba(237,191,171,0.9)]"
        >
          начать сейчас
        </Link>
      </div>
