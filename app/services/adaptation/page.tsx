...
export default function AdaptationPage() {
  return (
    <div className="flex flex-col min-h-screen adaptation-page">
      <ProfileHeader />
      {/* Πρώτος NewHeroSlider */}
      <div className="relative">
        <NewHeroSlider
          contentType="image"
          src="/images/section/adaptation.jpg"
          title="Адаптация"
          text="Переезд, смена работы, новые жизненные обстоятельства — адаптация к переменам может быть сложной. Мы поможем тебе пройти этот путь с меньшим стрессом и большей уверенностью."
        />
      </div>
