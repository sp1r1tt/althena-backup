...
export default function SelfConfidencePage() {
  return (
    <div className="flex flex-col min-h-screen self-confidence-page">
      <ProfileHeader />
      {/* Πρώτος NewHeroSlider */}
      <div className="relative">
        <NewHeroSlider
          contentType="image"
          src="/images/section/Self-esteem.jpg"
          title="Самооценка и уверенность в себе"
          text="Строим уверенность, повышаем самооценку — шаг за шагом. Узнайте, как замечать свои сильные стороны и поддерживать себя в трудные моменты."
        />
      </div>
      ...
      {/* Εισαγωγή του SelfImprovementPrompt Component */}
      ...
      <div className="flex-grow w-full bg-[rgba(237,191,171,0.2)] px-4 xs:px-6 sm:px-8 py-8 mt-[8px]">
        <div className="w-full max-w-[1120px] mx-auto">
          <p className="text-base xs:text-base sm:text-lg leading-[1.3] mb-4 whitespace-pre-line">
            Самопознание — это путешествие к пониманию себя, своих желаний, страхов и возможностей. Мы поможем вам исследовать свои внутренние ресурсы и найти путь к гармонии.
          </p>
          <p className="text-base xs:text-base sm:text-lg leading-[1.3] mb-4 whitespace-pre-line">
            В этом разделе вы узнаете, как:
          </p>
          <ul className="text-base xs:text-base sm:text-lg leading-[1.3] list-disc pl-5 mb-4">
            <li>Распознавать свои эмоции и их влияние на вашу жизнь.</li>
            <li>Развивать осознанность через практики mindfulness.</li>
            <li>Работать с внутренними убеждениями, которые могут вас ограничивать.</li>
            <li>Создавать личные цели, которые вдохновляют и мотивируют.</li>
          </ul>
          <p className="text-base xs:text-base sm:text-lg leading-[1.3] mb-4 whitespace-pre-line">
            Мы предлагаем безопасное пространство для исследования себя через упражнения, аудиогиды и мини-курсы, которые помогут вам глубже понять, кто вы есть, и чего вы хотите.
          </p>
          ...
          <p className="text-base xs:text-base sm:text-lg leading-[1.3] whitespace-pre-line">
            Самопознание — это ключ к осознанной и наполненной жизни. Понимая себя, вы можете принимать более осознанные решения, строить здоровые отношения и находить внутренний покой.
          </p>
